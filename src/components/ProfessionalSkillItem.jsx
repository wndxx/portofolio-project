...
export default function ProfessionalSkillItem({ skill }) {
    return (
      <div className="flex gap-4 p-4 rounded-3xl bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border border-gray-200 dark:border-gray-700">
